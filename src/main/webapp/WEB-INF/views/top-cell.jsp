...
<c:forEach items="${topForms}" var="book">
 ...
 <section class="request">
  <div class="line">
   <div class="row book_img">
    <a href="${detailLink}"><img class="javabook"
     src="resources/img/sample_book.jpg" alt=""></a> <img
     class="material" src="resources/img/book.png" alt=""> <img
